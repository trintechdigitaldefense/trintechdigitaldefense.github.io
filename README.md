...
Cybersecurity consultant based in Trinidad & Tobago, serving businesses across the Caribbean. I specialize in **vulnerability assessment**, **network auditing**, **OSINT reconnaissance**, and **incident response** — helping organizations identify vulnerabilities before attackers do.
...
[![Book Now](https://img.shields.io/badge/Book%20Free%20Scoping%20Call-Click%20Here-blue?style=for-the-badge&logo=calendly)](https://trintechdigitaldefense.github.io/#contact)
...
*Python · Line of Defense Engine*

Comprehensive system defense with filesystem integrity monitoring, SSH brute force blocking, process scanning, reverse shell detection, and system hardening audit. Active deception meets real-time threat detection.
...
| **Vulnerability Assessment** | Custom quote · Web, mobile, network |
